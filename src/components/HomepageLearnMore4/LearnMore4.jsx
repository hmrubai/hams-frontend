...
const LearnMore4 = () => {
  ...
  return (
    <div>
      <div>
        <section className="learnMore4-section-bg-image  d-flex flex-column justify-content-center align-items-center">
          <div className="d-flex flex-column align-items-center"></div>
          <h1 className="text-white text-center">
            We Respect
            <br />
            <span className="hero-text">Water</span>
          </h1>
