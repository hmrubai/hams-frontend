...
import DyeingFinishingUnit from "../../assets/AllAssets/ourBusiness/DyeingAndFinishingUnit.jpeg";
import "./OurBusinessStyle.css";

const DyeingFinishing = () => {
  return (
    <>
          ...
          <div className="col-12">
            <div className="row">
              ...
              <div className="col-md-4 p-3 gap-3 justify-content-center align-content-center">
                <div className="py-2 py-md-5 py-sm-0">
...
export default DyeingFinishing;
