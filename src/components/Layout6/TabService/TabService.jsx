...
const TabService = () => {
  const services = [
    {
      id: "1",
      secondaryHeading: "Design Studio",
      primaryHeading: "Knitting",
      description:
        "HAMS Design Studio stands as the creative nucleus within the HAMS Group, pioneering the innovative and trendsetting designs that define the essence of the brand. This cutting edge studio is the birthplace of fashion-forward concepts and styles, driving the garment manufacturing process with an emphasis on aesthetics, functionality, and market relevance. Comprising a team of skilled designers, pattern makers, and trend analysts, the HAMS Design Studio is committed to staying ahead of industry trends, delivering fresh and captivating designs that resonate with diverse consumer preferences. This hub of creativity plays a pivotal role in ensuring that HAMS garments are not only of the highest quality but also at the forefront of fashion innovation. HAMS Garments utilizes advanced technology, including 3D design tools like Clo3D, to streamline and enhance the sample development process. Here's an overview of how samples are developed with 3D designs at HAMS:",
      list1:
        "Digital Design Creation: The process starts with digital design creation using 3D design software.Designers at HAMS use tools like Clo3D to visualize garments in a three dimensional space.",
