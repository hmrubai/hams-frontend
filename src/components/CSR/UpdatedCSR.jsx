...
import DigitalPayment from "../../assets/AllPhotoFinal/CSR/Digital-Payment-System.jpg";
import HealthcareEducation from "../../assets/AllPhotoFinal/CSR/Healthcare&Education-Initiatives.jpg";
import SustainableFabric from "../../assets/AllPhotoFinal/CSR/Sustainable-Fabric-Production.jpg";
import Women from "../../assets/AllPhotoFinal/CSR/Women-Empowerment.jpg";
import WorkersWelfare from "../../assets/AllPhotoFinal/CSR/Workers-Welfare.jpg";
import "./CSR.css";
  ...
  return (
    <>
      <div className="container my-2 text-center">
        <h5 className="fw-bold">CSR Activities</h5>
        <p className="mx-5 text-justify text-center">
      ...
      <div className="container text-center d-flex justify-content-center align-items-center">
        <p className="w-75 text-justify text-center">
          HAMSGL's CSR endeavors exemplify a holistic approach that goes beyond
          compliance, aiming to create a positive impact on the lives of its
          employees and the communities it operates in. The company's commitment
          to ethical business practices and sustainable development reinforces
          its position as a socially responsible player in the garment
