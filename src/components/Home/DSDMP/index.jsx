...
import edit from "../../../assets/AllAssets/HomePage/about/edit.png";
import settings from "../../../assets/AllAssets/HomePage/about/settings.png";
import cloth from "../../../assets/AllAssets/HomePage/about/cloth.png";
import rain from "../../../assets/AllAssets/HomePage/about/rain.png";
import healthcare from "../../../assets/AllAssets/HomePage/about/healthcare.png";
...
const index = () => {
  ...
  return (
    <div className="container-sm my-">
      <Row className="">
        <Col lg={12} xl={12} md={12} className="mx-auto my- p-3">
          <Row className="d-flex justify-content-center my- mx-auto">
            {ideaData.map((idea) => (
              <CardDetails key={idea.id} idea={idea}></CardDetails>
            ))}
          </Row>
        </Col>
      </Row>
